...
public class WhisperModels {
	...
	public static final ModelData ENGLISH_TINY = new ModelData(
		"English-39 (default)",
		true,
		"tiny_en_acft_q8_0.bin.not.tflite",
	...
	public static final ModelData MULTILINGUAL_SMALL = new ModelData(
		"Multilingual-39 (74+ languages)",
		false,
		"tiny_acft_q8_0.bin",
	...
	public static String mapLanguageCode(String languageCode) {
		...
		// Map unsupported TT9 language codes (Whisper will auto-detect or use closest match)
		if ("zg".equals(languageCode) || "zgh".equals(languageCode)) {
			return "ar"; // Tamazight -> Arabic (geographically close, not natively supported)
		}
